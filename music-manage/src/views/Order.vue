        ...
        <div v-if="user.role === '0'">
            <div style="display: flex; flex-wrap: nowrap;">
                <el-select v-model="params.userId" placeholder="请选择用户" style="width: 200px; margin-right: 10px"
                    ...
                    <el-option v-for="item in userObjs" :key="item.id" :label="item.username"
            ...
            <div style="max-height: 80vh;overflow: auto;">
                <el-table :data="tableData" style="width: 100%; margin: 15px 0px" height="70vh" stripe
                    ...
                    <el-table-column prop="sts" label="订单状态" width="100" fixed="right">
...
export default {
    ...
    methods: {
        ...
        initUser() {
            request.get("/order/user/" + '-1').then(res => {
                if (res.code === '0') {
                    // console.log(res.data);
