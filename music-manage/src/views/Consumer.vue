<template>
    <div>
                    ...
                    <el-form :model="form">
                        ...
                        <el-form-item label="出生日期" label-width="20%" aria-required="true">
                            <el-date-picker v-model="form.birth" type="date" format="yyyy-MM-dd"
                                value-format="yyyy-MM-dd" placeholder="选择日期" style="width: 90%"></el-date-picker>
                        </el-form-item>
        ...
        <div v-if="user.role !== '0'">
            <h1 style="font-size: 80px ;margin-top:  20vh;margin-left:10vw;height: auto;color: red;">抱歉你没有权限浏览此页面</h1>
            <!-- <h2 style="display: block;margin-left: 44%;">{{ time }}秒后，返回首页</h2> -->
            <el-button type="primary" style="display: block;margin: 0 auto;"
                @click="$router.push('/')">点击返回首页</el-button>
        </div>
    </div>
